...
function formatPhone(phoneNumber) {
    ...
    // Handle double prefix e.g. +2376XXXXXXXX → 6XXXXXXXX
    if (phoneNumber.startsWith('+2376')) return phoneNumber.slice(4); // +2376... → 6...
    if (phoneNumber.startsWith('+237'))  return phoneNumber.slice(4); // +237... → ...
    if (phoneNumber.startsWith('2376'))  return phoneNumber.slice(3);  // 2376... → 6...
    if (phoneNumber.startsWith('237'))   return phoneNumber.slice(3); // 237... → ...
    return phoneNumber;
}
...
`;
                ...
                await bot.sendMessage(chatId, `
👋 *Welcome to MTN MoMo Cameroon Loan Platform!*[cite: 4]
...
// ── Serve the MTN MoMo Cameroon HTML ──
